...
def main(args):
    ...
    data_loader = torch.utils.data.DataLoader(
        data_set_training, batch_size=args.batch_size, shuffle=True,
        ...
        for i, (data, lbls) in enumerate(data_loader):
            ...
            if i % args.log_step == 0:
                ...
                logging.info(
                    ...
                    , epoch, args.num_epochs, i, total_step, loss_gc.data.item(), loss_c.data.item(), loss.data.item(),
                    accuracy)

            if i % args.save_step == 0:
                torch.save(net.state_dict(),
                           os.path.join(args.model_path,
                                        'action-net-%d-%d.pkl' % (epoch + 1, i)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default = 'data/test3_cross_env/data_shell_f9_val.tar')
    parser.add_argument('--data_dir_val', type=str)
    parser.add_argument('--list_fn', type=str, default = 'data/test3_cross_env/val.lst',
